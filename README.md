...
![sparkify schema](sparkify_schema.svg)
...
GROUP BY level;
```
![ratio of user levels](plays_per_level.png)
...
![ratio of user levels](users_per_level.png)
...
![ratio of user levels](browser.png)
...
![ratio of user levels](top_users_regions.png)